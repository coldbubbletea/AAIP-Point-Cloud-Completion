/************************************************************************************************
 * According to the X protocol, we indicate the use/modification of open source code:
 * 
 * EMD approximation module (based on auction algorithm) author: Minghua Liu
 * 
 * see https://github.com/Colin97/MSN-Point-Cloud-Completion
*================================================================================================*/
